...
export default function Loanform() {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object().shape({
            ...
            pancard: yup.string()
                .matches(/^[a-zA-Z]([ 0-9a-zA-Z]){2,}$/, "Pancard must be 10 digit long and does not start with a number, ex-HGRMS1739F")
                .required("Can't be left blank"),
            // creditscore: yup.string()
            // . matches(/^[6789]([0-9]){9}$/," credit should be at least 3 digits")
            //     .required("Can't be left blank"),

            income: yup.string()
                .matches(/^[6789]([0-9]){9}$/, " Your income number must be 7 digit long & should start with 7,8 or 9")
                .required("Can't be left blank"),
                    ...
                    <Grid item xs={12} sm={12} md={5} component={Paper} elevation={6} square>
                        ...
                        >
                            ...
                            <Box component="form" onSubmit={formik.handleSubmit} noValidate sx={{ mt: 1 }}>
                                ...
                                {formik.errors.pancard && formik.touched.pancard ? <span className='text-danger'>{formik.errors.pancard}</span> : null}
                                <TextField
                                    variant="outlined" size="small"
                                    onChange={formik.handleChange} onBlur={formik.handleBlur}
                                ...
                                {formik.errors.creditscore && formik.touched.creditscore ? <span className='text-danger'>{formik.errors.creditscore}</span> : null}
                                <TextField
                                    variant="outlined" size="small"
                                    onChange={formik.handleChange} onBlur={formik.handleBlur}
                                    ...
                                    name="income"
                                />
                                {formik.errors.income && formik.touched.income ? <span className='text-danger'>{formik.errors.income}</span> : null}

                                <FormControl>
                                    <FormLabel id="demo-row-radio-buttons-group-label">Property Identified</FormLabel>
                                    <RadioGroup
                                        row
                                        aria-labelledby="demo-row-radio-buttons-group-label"
                                        name="row-radio-buttons-group"
